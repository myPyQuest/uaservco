...
<div class="jsn-page-update">
	<div class="jsn-page-content jsn-rounded-large jsn-box-shadow-large jsn-bootstrap">
		<span id="jsn-update-cancel"><a class="jsn-link-action" href="<?php echo JRoute::_('index.php?option=' . $input->getCmd('option')); ?>"><?php echo JText::_('JCANCEL'); ?></a></span>
...
?>
			...
			<div class="form-actions">
				<p>
					<a id="jsn-proceed-button" class="btn btn-primary" href="<?php echo JRoute::_('index.php?option=' . $input->getCmd('option') . '&view=' . $input->getCmd('view') . '&task=update.download'); ?>"><?php echo JText::_('JSN_EXTFW_UPDATE_BUTTON'); ?></a>
				</p>
			</div>
		</div>
<?php
...
?>
				<ul>
					<li class="jsn-update-downloading" style="display: none;">
						...
						<span class="jsn-update-downloading-indicator jsn-icon16 icon-loading"></span>
					...
					<li class="jsn-update-installing" style="display: none;">
						...
						<span class="jsn-update-installing-indicator jsn-icon16 icon-loading"></span>
						<span class="jsn-update-downloading-notice jsn-processing-message"></span>
						<br />
