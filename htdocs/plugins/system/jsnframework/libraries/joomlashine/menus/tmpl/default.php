<?php
/**
 * @version     $Id: default.php 15485 2012-08-24 10:45:32Z cuongnm $
 * @package     JSNSample
 * @subpackage  item
			...
			<div class="jsn-fieldset-filter">
				<fieldset>
					...
					<div class="pull-right jsn-fieldset-select">
						<select name="menutype" class="inputbox" id="filter_menu_type" onchange="this.form.submit()">
			...
			<table class="table table-bordered table-striped table-popup">
				...
				<tbody>
					...
					foreach ($this->items as $i => $item) :
						?>
						<tr onclick="if (window.parent) window.parent.jQuery.<?php echo $this->escape($function);?>('<?php echo $item->id;?>', '<?php echo $item->title;?>', null,'<?php echo $this->escape($item->link) . "&Itemid=" . $item->id;?>');">
							<td>
