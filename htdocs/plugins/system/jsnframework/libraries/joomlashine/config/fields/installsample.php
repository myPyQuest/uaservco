<?php
/**
 * @version     $Id: installsample.php 16159 2012-09-19 09:01:26Z cuongnm $
	...
	<div id="jsn-data-install-sample-indicator" style="display: none;">
		...
		<ul>
			<li id="jsn-data-install-sample-downloading">
				...
				<span id="jsn-data-install-sample-downloading-indicator" class="jsn-icon16 icon-loading"></span>
			...
			<li id="jsn-data-install-sample-installing" style="display: none;">
				...
				<span id="jsn-data-install-sample-installing-indicator" class="jsn-icon16 icon-loading"></span>
