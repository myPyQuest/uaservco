<?php
/**
 * @version     $Id: default.php 15298 2012-08-21 04:05:13Z cuongnm $
...
<div class="jsn-page-configuration">
	<div class="jsn-bootstrap jsn-bgpattern pattern-sidebar">
		<div>
<?php
	require dirname(__FILE__) . DS . str_replace('.php', '_menu.php', basename(__FILE__));
?>
...
{
	$tabs = & $blocks;
	require dirname(__FILE__) . DS . str_replace('.php', '_tabs.php', basename(__FILE__));
}
else
{
	$fieldsets = & $blocks;
	require dirname(__FILE__) . DS . str_replace('.php', '_form.php', basename(__FILE__));
}
