 ...
 * @version $Id: form.php 15748 2012-08-31 10:45:14Z giangnd $
...
<div id="jsn-showlist-settings" class="jsn-page-edit">
	<div id="jsn_is_showlist_tabs" class="jsn-tabs">
		<ul>
			<li><a href="#tab-showlist-setting"><?php echo JText::_('SHOWLIST_TITLE_SHOWLIST_DETAILS');?></a></li>
			<li><a href="#tab-showlist-images"><?php echo $text;?></a></li>
		</ul>
<?php
echo '<div id="tab-showlist-setting">'.$this->loadTemplate('showlist').'</div>';
echo '<div id="tab-showlist-images" class="jsn-showlist-images jsn-section">';
		if($task == 'add'){
			echo '
