		...
		<div class="source-media-panel-container">
			<div class="panel-right jsn-bootstrap">
				<div class="panel-header clearafter jsn-iconbar" id="source-media-header">
					<a href="javascript: void(0);" class="media-show-grid pull-left jsn-icon16 icon-layout icon-thumbnails disabled" title="<?php echo JText::_('SHOWLIST_IMAGE_MANAGER_SELECT_THUMB_PRESENTATION_MODE'); ?>"></a>
					<a href="javascript: void(0);" class="media-show-list pull-left jsn-icon16 icon-layout icon-thumbnaildetails disabled" title="<?php echo JText::_('SHOWLIST_IMAGE_MANAGER_SELECT_DETAILS_PRESENTATION_MODE'); ?>"></a>
					<a href="javascript: void(0);" class="pull-right jsn-icon16 icon-ok disabled" id="move-selected-media-source" title="<?php echo JText::_('SHOWLIST_IMAGE_MANAGER_ADD_SELECTED_IMAGE'); ?>">
					</a>
				</div>
	...
	<div class="ui-layout-center" id="panel-center">
		...
		<div class="source-media-panel-container jsn-bootstrap">
			<div class="panel-header clearafter jsn-iconbar" id="showlist-media-header">
				<a href="javascript: void(0);" class="media-show-grid pull-left jsn-icon16 icon-layout icon-thumbnails disabled" title="<?php echo JText::_('SHOWLIST_IMAGE_MANAGER_SELECT_THUMB_PRESENTATION_MODE'); ?>"></a>
				<a href="javascript: void(0);" class="media-show-list pull-left jsn-icon16 icon-layout icon-thumbnaildetails disabled" title="<?php echo JText::_('SHOWLIST_IMAGE_MANAGER_SELECT_DETAILS_PRESENTATION_MODE'); ?>"></a>
				<a href="javascript: void(0);" class="pull-right jsn-icon16 icon-trash disabled" id="delete-media-showlist"  <?php if ($sync=='sync'){ echo 'style="display:none;"';}?> title="<?php echo JText::_('SHOWLIST_IMAGE_MANAGER_DELETE_SELECTED_IMAGE'); ?>">
				</a>
				<a href="javascript: void(0);" class="pull-right jsn-icon16 icon-pencil disabled" id="edit-media-showlist"  <?php if ($sync=='sync'){ echo 'style="display:none;"';}?> title="<?php echo JText::_('SHOWLIST_IMAGE_MANAGER_EDIT_SELECTED_IMAGE'); ?>">
				</a>
				<div class="clearbreak"></div>
			</div>
			<div class="source-media-container" id="showlist-media-container">
				<div class="showlist-items showgrid <?php if (count($imagesStored) == 0){ echo 'jsn-section-empty'; }?>" id="showlist-items">
