...
# @version $Id: jsnpoweradmin.php 16702 2012-10-04 10:03:32Z hiepnv $
-------------------------------------------------------------------------*/
...
class plgSystemJsnpoweradmin extends JPlugin
{
	...
	function __construct(&$subject, $config)
	{
		...
		if ($app->isAdmin()){
			...
			if (JRequest::getVar('tmpl') == 'component' && !JRequest::getVar('ajax')){
...
// 		}
	...
	**/
    ...
    public function onAfterInitialise(){
		...
		if (JRequest::getVar('tmpl') == 'component' && JRequest::getVar('option') == 'com_poweradmin' && !JRequest::getVar('ajax')){
