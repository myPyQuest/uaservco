(function (win, doc) {
	...
	win.JSNHttpDownload.prototype = {
		 ...
		 *
		 * @param   string  fileUrl  URL of file to be downloaded
		 * 
		 * @return  void
		 */
		start: function (fileUrl) {
			var self = this;

			if (this.useIFrame == true) {
				var url = 'download.php?file=' + encodeURIComponent(fileUrl)
			...
			this.xhr.open('POST', 'download.php', true);
			this.xhr.setRequestHeader('content-type', 'application/x-www-form-urlencoded');
			this.xhr.send('file=' + encodeURIComponent(fileUrl) + '&process=' + this.processId);
