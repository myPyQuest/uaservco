<?php
/**
 * @version     $Id: default.php 16039 2012-09-14 05:12:12Z hiepnv $
...
$name		= preg_replace('/JSN\s*/i', '', $info->name);
...
<div class="jsn-page-upgrade">
	<div class="jsn-page-content jsn-rounded-large jsn-box-shadow-large jsn-bootstrap">
		<span id="jsn-upgrade-cancel"><a class="jsn-link-action" href="<?php echo JRoute::_('index.php?option=' . $input->getCmd('option')); ?>"><?php echo JText::_('JCANCEL'); ?></a></span>
...
?>
			...
			<div class="form-actions">
				<p>
					<a id="jsn-proceed-button" class="btn btn-primary" href="<?php echo JRoute::_('index.php?option=' . $input->getCmd('option') . '&view=' . $input->getCmd('view') . '&task=upgrade.download'); ?>"><?php echo JText::_($edition == 'free' ? 'JSN_EXTFW_UPGRADE_BUTTON_FREE' : 'JSN_EXTFW_UPGRADE_BUTTON_PRO'); ?></a>
				</p>
				<p>
					<a href="<?php echo $buyNow; ?>" target="_blank" class="jsn-link-action"><?php echo JText::_($edition == 'free' ? 'JSN_EXTFW_UPGRADE_LINK_FREE' : 'JSN_EXTFW_UPGRADE_LINK_PRO'); ?></a>
				</p>
			</div>
		</div>
		...
		<div id="jsn-upgrade-indicator" style="display: none;">
			...
			<ul>
				<li id="jsn-upgrade-downloading">
					...
					<span id="jsn-upgrade-downloading-indicator" class="jsn-icon16 icon-loading"></span>
				...
				<li id="jsn-upgrade-installing" style="display: none;">
					...
					<span id="jsn-upgrade-installing-indicator" class="jsn-icon16 icon-loading"></span>
					<span id="jsn-upgrade-downloading-notice" class="jsn-processing-message"></span>
					<br />
		...
		<div id="jsn-upgrade-successfully" style="display: none;">
			...
			<div class="form-actions">
				...
				?>
				<p>
					<a class="btn btn-primary" href="<?php echo JRoute::_($_redir); ?>"><?php echo JText::_('JSN_EXTFW_UPDATE_FINISH'); ?></a>
				</p>
			</div>
		</div>
	</div>
